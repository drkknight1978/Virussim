# TO DO's
# 1. Create a Technique for adding a border DONE 14/04/2020
# 2. Create a psuedoname function.
...
#a quick and dirty way to display text on the screen. to be developed.
def text_display(inpsurface, txtstring, x,y):
    pass
...
if __name__ == "__main__":
    ...
    while  running != False:
        ...
        #print(listtostr (record) + '/n') #This prints the population.
